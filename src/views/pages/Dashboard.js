...
class Dashboard extends Component {
  ...
  render() {
    ...
    return (
      <div>
        <div className="m-b">
          <h2>Bienvenido al sistema de Administración FENIX</h2>
        ...
        <Row>
          <Col md={8} sm={12}>
            <Card>
              <CardHeader>Conversiones</CardHeader>
              <CardBody>
                <Row className="m-b-md">
                  <Col xs={4}>
                    <h5>Adición al carrito</h5>
                    <div className="h2">4.30%</div>
                    <small className="text-muted">23 Visitantes</small>
                  </Col>
                  <Col xs={4}>
                    <h5>Pago alcanzado</h5>
                    <div className="h2">2.93</div>
                    <small className="text-muted">12 Visitantes</small>
                  </Col>
                  <Col xs={4}>
                    <h5>Compras</h5>
                    <div className="h2">10</div>
                    <small className="text-muted">10 Clientes</small>
                  </Col>
                </Row>
              </CardBody>
            </Card>
